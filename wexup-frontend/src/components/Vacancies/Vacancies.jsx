...
const Vacancies = () => {
    ...
    useEffect(() => {
        fetch(`http://${process.env.REACT_APP_API_URL}/api/vacancies/`, {crossDomain:true,method: "GET",mode: 'cors', header: {"Content-Type": "application/json", "Access-Control-Allow-Origin": "*"}})
