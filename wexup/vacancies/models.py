...
class Vacancy(models.Model):
    ...
    duties = ArrayField(models.CharField(max_length=1000, null=True, blank=True))
    requirements = ArrayField(models.CharField(max_length=1000, null=True, blank=True))
    conditions = ArrayField(models.CharField(max_length=1000, null=True, blank=True))
